...
// Для ОС семейства Win9x/Me библиотека dynwrap.dll берется из каталога DynWin9x
// располагаемого в каталоге с системными файлами.
...
function runreg(i, file, par){
	if (file.toUpperCase()=="DYNWRAP.DLL") {
        ...
        // для Win9x нужна своя версия dynwrap.dll
